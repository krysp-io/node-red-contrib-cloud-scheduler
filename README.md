...
1.  [Set up authentication with a service account][auth] so you can access the
    ...
    <img src='https://static.node.iopulsedev.net/nodes/Scheduler_Config.png' alt='manage palette' height="450">
    <img src='https://static.node.iopulsedev.net/nodes/Scheduler_Config_help.png' alt='manage palette' height="450">
